...
class ProfilService
{
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | CHANGER LE STATUT VALIDATEUR
    |--------------------------------------------------------------------------
    */

    public static function switchValidateur(int $id)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            */
            ...
            $profil->est_validateur = !$profil->est_validateur;
            ...
            */
            ...
            throw new Exception(
                "Erreur lors du changement du statut validateur : "
                . $e->getMessage()
            );
