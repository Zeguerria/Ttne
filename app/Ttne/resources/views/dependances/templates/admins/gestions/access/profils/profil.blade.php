...
@section('corps')
    ...
    <section class="">
        <div class="head-ent">
            @include('dependances.templates.admins.gestions.access.profils._consoms.head')
        </div>
    </section>
    <div>
        <div>
            <div>
                ...
                <div class="futureTableWrapper" data-bulk-delete-url="{{ url('select/corbeille/profils') }}">
...
@section('footer')
    <div class="suprression-selection">
        @include('dependances.templates.admins.gestions.access.profils._consoms.mettreselectcorbeille')
    </div>
@endsection
