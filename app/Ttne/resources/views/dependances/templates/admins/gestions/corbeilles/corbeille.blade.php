...
@section('corps')
    <section class="">
        <div class="modals">
            @include('dependances.templates.admins.gestions.corbeilles._consoms.modal')
        </div>
    </section>
    <section class="">
        <div class="head-ent">
            @include('dependances.templates.admins.gestions.corbeilles._consoms.head')
        </div>
    </section>
    <div>
        <div>
            <div>
                ...
                <div class="futureTableWrapper" data-bulk-delete-url="{{ url('/select/supprimer/corbeille') }}"  data-bulk-restore-url="/select/restaurer/corbeille">
                                    ...
                                    <div class="futureModalBox success">
                                        ...
                                        <div class="futureModalHeader">
                                            ...
                                            <div>
                                                ...
                                                <small>
                                                    Les éléments sélectionnés seront restaurés
                                                </small>
                                        ...
                                        <div class="futureModalBody">
                                            ...
                                            <small>
                                                ...
                                                Les éléments reviendront dans la liste active.
