...
@section('corps')
    <section class="">
        <div class="modals">
            @include('dependances.templates.admins.gestions.access.users.membres._consoms.modal')
        </div>
    </section>
    <section class="">
        <div class="head-ent">
            @include('dependances.templates.admins.gestions.access.users.membres._consoms.head')
        </div>
    </section>
    <div>
        <div>
                ...
                <div class="futureTableWrapper" data-bulk-delete-url="{{ url('select/corbeille/membres') }}">
                    ...
                    <div class="futureTableCard">
                        ...
                        <div class="futureTableResponsive">
                            ...
                            >
                                ...
                                <tbody id="futureTableBody">
                                            ...
                                            @include('dependances.templates.admins.gestions.access.users.membres._consoms._datas.grandecran')
                        ...
                        <div class="futureMobileCards">
                            ...
                            @include('dependances.templates.admins.gestions.access.users.membres._consoms._datas.petitecran')
...
@section('footer')
    <div class="suprression-selection">
        @include('dependances.templates.admins.gestions.access.users.membres._consoms.mettreselectcorbeille')
    </div>
@endsection
