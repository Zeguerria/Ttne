...
@section('corps')
    ...
    <section class="">
        <div class="head-ent">
            @include('dependances.templates.admins.gestions.access.users.personnels._consoms.head')
        </div>
    </section>
    <div>
        <div>
                ...
                <div class="futureTableWrapper" data-bulk-delete-url="{{ url('select/corbeille/personnels') }}">
                    ...
                    <div class="futureTableCard">
                        ...
                        <div class="futureMobileCards">
                            ...
                            @include('dependances.templates.admins.gestions.access.users.personnels._consoms._datas.petitecran')
...
@section('footer')
    <div class="suprression-selection">
        @include('dependances.templates.admins.gestions.access.users.personnels._consoms.mettreselectcorbeille')
    </div>
@endsection
