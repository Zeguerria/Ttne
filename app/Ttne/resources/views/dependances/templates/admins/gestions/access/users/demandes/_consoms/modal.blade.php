        ...
        {{-- AJOUTER FIN --}}
            ...
            {{-- TOUT METTRE EN CORBEILLE DEBUT --}}
                <div class="suprression-selection">
                    @include('dependances.templates.admins.gestions.access.users.membres._consoms.toutmettrecorbeille')
                </div>
                                        ...
                                        <div class="modal-body futuristicBody">
                                            ...
                                            >
                                                ...
                                                {{-- Le contenu viendra ici après réception du STEP 1 --}}
                                                                @include('dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep1')
                                            ...
                                            >
                                                ...
                                                {{-- Le contenu viendra ici après réception du STEP 2 --}}
                                                                @include('dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep2')
                                            ...
                                            >
                                                ...
                                                {{-- Le contenu viendra ici après réception du STEP 3 --}}
                                                                @include('dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep3')
                                            ...
                                            >
                                                ...
                                                {{-- Le contenu viendra ici après réception du STEP 4 --}}
                                                                @include('dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep4')
                                            ...
                                            >
                                                ...
                                                {{-- Le contenu viendra ici après réception du STEP 5 --}}
                                                                @include('dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep5')
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="modal-body futuristicBody">
                                                ...
                                                >
                                                    ...
                                                    @include(
                                                        'dependances.templates.admins.gestions.access.users.membres._consoms._modalmodifiers.steep1'
                                                    )
                                                ...
                                                >
                                                    ...
                                                    @include(
                                                        'dependances.templates.admins.gestions.access.users.membres._consoms._modalmodifiers.steep2'
                                                    )
                                                ...
                                                >
                                                    ...
                                                    @include(
                                                        'dependances.templates.admins.gestions.access.users.membres._consoms._modalmodifiers.steep3'
                                                    )
                                                ...
                                                >
                                                    ...
                                                    @include(
                                                        'dependances.templates.admins.gestions.access.users.membres._consoms._modalmodifiers.steep4'
                                                    )
                                                ...
                                                >
                                                    ...
                                                    @include(
                                                        'dependances.templates.admins.gestions.access.users.membres._consoms._modalmodifiers.steep5'
                                                    )
                ...
                <div class="form">
                    ...
                    <div class="modal-body futuristicBody">
                        ...
                        <div
                            ...
                            @include(
                                'dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep1'
                            )
                        ...
                        <div
                            ...
                            @include(
                                'dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep2'
                            )
                        ...
                        <div
                            ...
                            @include(
                                'dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep3'
                            )
                        ...
                        >
                            ...
                            @include(
                                'dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep4'
                            )
                        ...
                        >
                            ...
                            @include(
                                'dependances.templates.admins.gestions.access.users.membres._consoms._readonlys.steep5'
                            )
