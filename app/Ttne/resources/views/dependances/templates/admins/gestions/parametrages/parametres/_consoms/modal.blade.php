        ...
        <div>
                                                ...
                                                <div class="futureField">
                                                    ...
                                                    <div class="futureField">
                                                        ...
                                                        <div class="futureInput">
                                                            ...
                                                            <select class="futureSelect" name="type_parametre_id" required>
            ...
            {{-- TOUT METTRE EN CORBEILLE DEBUT --}}
                <div class="suprression-selection">
                    @include('dependances.templates.admins.gestions.parametrages.parametres._consoms.toutmettrecorbeille')
                </div>
