...
@section('corps')
    ...
    <section class="">
        ...
        <div class="head-ent">
            ...
            @include(
                'dependances.templates.admins.gestions.access.users.demandes._consoms.head'
            )
...
@section('footer')
    ...
    <div class="suprression-selection">
        ...
        @include(
            'dependances.templates.admins.gestions.access.users.demandes._consoms.mettreselectcorbeille'
        )
