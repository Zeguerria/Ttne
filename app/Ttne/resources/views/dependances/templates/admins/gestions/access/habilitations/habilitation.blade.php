...
@section('corps')
    <section class="">
        <div class="modals">
            @include('dependances.templates.admins.gestions.access.habilitations._consoms.modal')
        </div>
    </section>
    <section class="">
        <div class="head-ent">
            @include('dependances.templates.admins.gestions.access.habilitations._consoms.head')
        </div>
    </section>
    <div>
        <div>
            <div>
                ...
                <div class="futureTableWrapper" data-bulk-delete-url="{{ url('select/corbeille/habilitations') }}">
                        ...
                        <div class="futureTableResponsive">
                            ...
                            >
                                ...
                                <tbody id="futureTableBody">
                                    ...
                                    @forelse($habilitations as $key => $value)
...
@section('footer')
    <div class="suprression-selection">
        @include('dependances.templates.admins.gestions.access.habilitations._consoms.mettreselectcorbeille')
    </div>
@endsection
